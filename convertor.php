    ...
    */
    ...
    if (($key > 0) xor (strlen($cit) > 1)) {
        if ($key > 0) {
            ...
            $command_line = "cd  /var/www/hatanach/verse/script/ && node citapp.js -c " . " '" . $cit . "'  2>&1";
            ...
            if (single_verse($osis)) {
                ...
                switch (count($bcv)) {
                    case 1:
                        ...
                        $chapter_number = 1;
                        list($book) = $bcv;
                        if (strpos($book, "EEE") > 0) {
                            $book_code = shorteng_bookcode($cit);
                        } else {
                ...
                if ($debug_flag) {
                    echo "<p debug='convert_cit_key end";
                    var_dump($book_code, $chapter_number, $verse_number);
                    echo "'></p>";
                }
